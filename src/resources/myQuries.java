...
public class myQuries{
    ...
    public final static String transactionsByZip= "SELECT CDW_SAPP_CREDITCARD.* FROM CDW_SAPP_CUSTOMER LEFT JOIN CDW_SAPP_CREDITCARD ON CDW_SAPP_CUSTOMER.CREDIT_CARD_NO = CDW_SAPP_CREDITCARD.CREDIT_CARD_NO WHERE CUST_ZIP= ? AND MONTH = ? AND YEAR = ? ORDER BY DAY DESC" ;
